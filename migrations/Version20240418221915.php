 ...
 */
final class Version20240418221915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact ADD parent_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_4C62E638727ACA70');
        $this->addSql('ALTER TABLE contact DROP parent_id');
    }
}
