 ...
 */
final class Version20240423110112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE materiel (id INT NOT NULL, category_id INT NOT NULL, name VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, purchase_price NUMERIC(10, 2) DEFAULT NULL, argus_price NUMERIC(10, 2) DEFAULT NULL, rent_price NUMERIC(10, 2) DEFAULT NULL, invoice VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE materiel DROP CONSTRAINT FK_18D2B09112469DE2');
