...
final class Version20241020150819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partner (id INT NOT NULL, logo VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, photo_live VARCHAR(255) DEFAULT NULL, photo_team VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
