...
final class Version20240512134529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partnership (id INT NOT NULL, partner_type VARCHAR(255) DEFAULT NULL, partner_name VARCHAR(255) NOT NULL, partner_email VARCHAR(255) NOT NULL, partner_phone VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, message TEXT DEFAULT NULL, sent_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, accepted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, rejected_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
