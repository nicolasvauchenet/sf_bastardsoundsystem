...
class EquipmentFixtures extends Fixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        $equipment = (new Equipment())
            ->setCategory($this->getReference('equipment-category-materiel-informatique'))
        ...
        $equipment = (new Equipment())
            ->setCategory($this->getReference('equipment-category-microphones'))
            ->setName('ADK A51-S')
        ...
        $equipment = (new Equipment())
            ->setCategory($this->getReference('equipment-category-mixage-et-effets'))
        ...
        $equipment = (new Equipment())
            ->setCategory($this->getReference('equipment-category-sonorisation-foh'))
        ...
        $equipment = (new Equipment())
            ->setCategory($this->getReference('equipment-category-stands-microphone'))
        ...
        $equipment = (new Equipment())
            ->setCategory($this->getReference('equipment-category-equipement-plateau'))
