...
class ServiceFixtures extends Fixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        $service = (new Service())
            ...
            ->setSlug('technique-sonorisation')
        ...
        $service = (new Service())
            ...
            ->setSlug('technique-dossier-technique')
        ...
        $service = (new Service())
            ...
            ->setSlug('management-merchandising')
        ...
        $service = (new Service())
            ...
            ->setSlug('management-declarations-et-assurances')
        ...
        $service = (new Service())
            ...
            ->setSlug('organisation-concerts-et-tournees')
        ...
        $service = (new Service())
            ...
            ->setSlug('organisation-co-organisation')
        ...
        $service = (new Service())
            ...
            ->setSlug('production-live-recording')
        ...
        $service = (new Service())
            ...
            ->setSlug('production-co-production')
