...
class ServiceFixtures extends Fixture implements OrderedFixtureInterface
{
    ...
    {
        $service = (new Service())
            ->setCategory($this->getReference('service-category-technique'))
        ...
        $service = (new Service())
            ->setCategory($this->getReference('service-category-management'))
            ->setName('Logos')
        ...
        $service = (new Service())
            ->setCategory($this->getReference('service-category-organisation'))
        ...
        $service = (new Service())
            ->setCategory($this->getReference('service-category-production'))
