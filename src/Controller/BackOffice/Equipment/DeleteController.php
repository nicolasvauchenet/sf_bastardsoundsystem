...
{
    #[Route('/administration/materiel/supprimer/{id}', name: 'app_back_office_equipment_delete')]
                           ...
                           Equipment              $equipment): Response
    {
        ...
        return $this->redirectToRoute('app_back_office_equipment_home');
    }

    #[Route('/administration/materiel/image/supprimer/{id}', name: 'app_back_office_equipment_image_delete')]
                                ...
                                Equipment              $equipment): Response
    {
        ...
        return $this->redirectToRoute('app_back_office_equipment_view', ['slug' => $equipment->getSlug()]);
    }

    #[Route('/administration/materiel/facture/supprimer/{id}', name: 'app_back_office_equipment_invoice_delete')]
